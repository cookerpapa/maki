...
// Luau's MAXSSIZE and MAX_BUFFER_SIZE both allow up to 1 GiB.
const MAX_READ_BYTES: u64 = 1 << 30;
...
mod tests {
    ...
    #[cfg(unix)]
    const READ_LIMIT_ERROR: &str = "file exceeds the 1073741824-byte read limit";
